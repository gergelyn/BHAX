...
public class MandelbrotHalmazNagyito extends MandelbrotHalmaz {
    ...
    /**
     * Letrehoz egy a Mandelbrot halmazt a komplex sik [a,b]x[c,d] tartomanya felett
     * kiszamolo es nygitani tudo <code>MandelbrotHalmazNagyito</code> objektumot.
     *
     ...
     */
    public MandelbrotHalmazNagyito(double a, double b, double c, double d, int szelesseg, int iteraciosHatar) {
        ...
        addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mousePressed(java.awt.event.MouseEvent m) {
                ...
                if (m.getButton() == java.awt.event.MouseEvent.BUTTON1) {
                    ...
                    MandelbrotIteraciok iteraciok = new MandelbrotIteraciok(MandelbrotHalmazNagyito.this, 50);
            ...
            public void mouseReleased(java.awt.event.MouseEvent m) {
                if (m.getButton() == java.awt.event.MouseEvent.BUTTON1) {
                    double dx = (MandelbrotHalmazNagyito.this.b - MandelbrotHalmazNagyito.this.a)
                            / MandelbrotHalmazNagyito.this.szelesseg;
                    double dy = (MandelbrotHalmazNagyito.this.d - MandelbrotHalmazNagyito.this.c)
                    ...
                    new MandelbrotHalmazNagyito(MandelbrotHalmazNagyito.this.a + x * dx,
                            ...
                            MandelbrotHalmazNagyito.this.d - y * dy - my * dy, MandelbrotHalmazNagyito.this.d - y * dy,
                            600, MandelbrotHalmazNagyito.this.iteraciosHatar);
                }
            }
        });
    ...
    public void pillanatfelvetel() {
        ...
        java.awt.image.BufferedImage mentKep = new java.awt.image.BufferedImage(szelesseg, magassag,
        ...
        try {
            javax.imageio.ImageIO.write(mentKep, "png", new java.io.File(sb.toString()));
